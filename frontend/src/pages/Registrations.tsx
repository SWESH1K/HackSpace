  ...
  if (profile) return (
    <div className="max-w-md mx-auto mt-8 p-6 bg-white dark:bg-zinc-900 rounded shadow">
      <div className="text-center space-y-4">
        ...
        <h2 className="text-xl font-bold text-gray-900 dark:text-white">Already Registered</h2>
        <p className="text-green-600 dark:text-green-400 font-medium">You are already a part of team.</p>
